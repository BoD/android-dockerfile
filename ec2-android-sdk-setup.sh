...
curl --progress-bar --location https://dl.google.com/android/repository/commandlinetools-linux-6609375_latest.zip > cmdline-tools.zip
...
echo y | cmdline-tools/tools/bin/sdkmanager --sdk_root=android-sdk 'platforms;android-29' > /dev/null
